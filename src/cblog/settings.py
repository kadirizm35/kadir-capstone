...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/kadir/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/kadir/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cozee0g02uix.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstoneskadirblog' # please enter your s3 bucket name
